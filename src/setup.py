...
packages = ["argparse", "async_timeout", "certifi", "charset_normalizer", "idna", "ifaddr", "lief", "openvr", "psutil", "pyparsing", "pythonosc", "requests", "urllib3", "zeroconf", "ctypes"]
exclude = ["tkinter", "concurrent", "lib2to3", "test", "unittest", "xmlrpc"]
