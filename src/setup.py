...
packages = ["argparse", "asyncio", "async_timeout", "certifi", "charset_normalizer", "idna", "ifaddr", "lief", "openvr", "psutil", "pyparsing", "pythonosc", "requests", "urllib3", "zeroconf", "ctypes"]
